...
/**
 * Delegates update requests to the ExtDoc views, registers ExtDoc with the editor's content assistant and stores the
 * current {@link IWorkbenchPartSite} as well as the last {@link IJavaElementSelection}.
 */
...
public final class UiManager implements IExtendedSelectionListener {
    ...
    @Inject
    public UiManager(final ExtDocView extDocView, final ProviderStore providerStore, final UpdateService updateService) {
