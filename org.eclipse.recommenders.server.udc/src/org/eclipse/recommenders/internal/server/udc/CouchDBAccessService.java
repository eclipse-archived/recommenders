...
public class CouchDBAccessService {
    ...
    private int getNumberOfObjectUsages(final String fingerprint) {
        final GenericResultObjectView<Integer> queryResult = client.doGetRequest(
                "_design/objectUsages/_view/byFingerprint?reduce=true&key=" + escapedQuotation + fingerprint
                        + escapedQuotation, new GenericType<GenericResultObjectView<Integer>>() {
                });
