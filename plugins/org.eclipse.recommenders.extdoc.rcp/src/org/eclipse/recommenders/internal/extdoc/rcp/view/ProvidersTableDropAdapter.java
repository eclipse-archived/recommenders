...
public final class ProvidersTableDropAdapter extends DropTargetAdapter {

    private final Table table;
    private final ProvidersTableDragListener dragListener;
    private final ProviderStore providerStore;

    public ProvidersTableDropAdapter(final Table table, final ProvidersTableDragListener dragListener,
