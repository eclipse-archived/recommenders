...
class SnippetCodeBuilderTest {
   ...
   def void testEntireSingleLineFileSelection() {
      val code = '''$public class TestEntireSingleLineFileSelection { int myInt; }$'''
      val actual = exerciseFullFile(code)

      assertEquals(
         '''public class TestEntireSingleLineFileSelection { int ${myInt:newName(int)}; }
${cursor}
        '''.toString, actual)
   }
   ...
   def void testEntireSingleLineFileSelectionWithLeadingWhitespaces() {
      val code = '''$   public class TestEntireSingleLineFileSelectionWithLeadingWhitespaces { int myInt; }$'''
      val actual = exerciseFullFile(code)

      assertEquals(
         '''public class TestEntireSingleLineFileSelectionWithLeadingWhitespaces { int ${myInt:newName(int)}; }
${cursor}
        '''.toString, actual)
   }
