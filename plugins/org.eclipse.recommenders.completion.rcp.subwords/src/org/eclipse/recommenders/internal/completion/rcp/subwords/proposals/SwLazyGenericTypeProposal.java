...
public final class SwLazyGenericTypeProposal extends LazyJavaTypeCompletionProposal {

    private final SubwordsProposalContext subwordsContext;

    public SwLazyGenericTypeProposal(final CompletionProposal proposal,
    ...
    private static class ContextInformation implements IContextInformation, IContextInformationExtension {
        ...
        ContextInformation(final SwLazyGenericTypeProposal swLazyGenericTypeProposal) {
        ...
        private String computeContextString(final SwLazyGenericTypeProposal proposal) {
            try {
