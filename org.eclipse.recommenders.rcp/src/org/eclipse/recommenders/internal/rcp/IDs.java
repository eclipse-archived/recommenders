...
public class IDs {
    ...
    public static final String COMPILATIONUNIT_VIEW_ID = "org.eclipse.recommenders.rcp.views.CompilationUnitView";

    public static final String IMG_PATH_SLICE = "icons/view16/slice.gif";
}
