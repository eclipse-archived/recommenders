...
public class CopyDemoDatabase implements Callable<IStatus> {
    ...
    @Inject
    public CopyDemoDatabase(@LocalCouchdb final WebServiceClient client, @LocalCouchdb final File couchConfigurationArea) {
        this.client = client;
    }
