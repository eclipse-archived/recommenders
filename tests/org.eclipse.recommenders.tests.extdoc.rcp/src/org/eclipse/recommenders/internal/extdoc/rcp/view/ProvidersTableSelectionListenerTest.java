...
public final class ProvidersTableSelectionListenerTest {
    ...
    public void testHandleEvent() {
        ...
        final ProvidersTable table = new ProvidersTable(ExtDocUtils.getShell(), new ProviderStore(), updateService);
        ...
        event.item = item;
        final ProvidersTableSelectionListener listener = new ProvidersTableSelectionListener(table, updateService);
