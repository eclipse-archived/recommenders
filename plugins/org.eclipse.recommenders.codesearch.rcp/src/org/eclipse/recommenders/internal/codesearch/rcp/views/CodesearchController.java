...
import org.eclipse.recommenders.internal.codesearch.rcp.utils.SummaryCodeFormatter;
...
public class CodesearchController {
    ...
    private final BiMap<Control, RCPProposal> controls2ProposalsIndex = HashBiMap.create();
