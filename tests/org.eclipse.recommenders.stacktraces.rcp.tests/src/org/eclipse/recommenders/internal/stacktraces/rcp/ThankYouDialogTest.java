...
public class ThankYouDialogTest {
    ...
    private static String M_TRACKED = MessageFormat.format(Messages.THANKYOUDIALOG_NEW, BUG_URL) + MESSAGE_INFO
            + MESSAGE_END;
    ...
    private static String M_VISIT = MessageFormat.format(Messages.THANKYOUDIALOG_MARKED_WORKSFORME, BUG_URL)
            + MESSAGE_INFO + MESSAGE_END;
    ...
    private static String M_NEED_INFO = MessageFormat.format(Messages.THANKYOUDIALOG_NEW, BUG_URL) + MESSAGE_INFO
            + MessageFormat.format(Messages.THANKYOUDIALOG_COMMITTER_NEEDINFO, BUG_URL)
    ...
    private static ReportState S_NEED_INFO_NULL = newReportState(BUG_URL, null,
            new String[] { ReportState.KEYWORD_NEEDINFO }, ReportState.UNKNOWN, ReportState.ASSIGNED, true);
    private static String M_NEED_INFO_NULL = MessageFormat.format(Messages.THANKYOUDIALOG_NEW, BUG_URL)
    ...
    private static ReportState newReportState(String bugUrl, String information, String[] keywords, String resolved,
        ...
        Mockito.when(mock.getBugId()).thenReturn(Optional.fromNullable("1"));
