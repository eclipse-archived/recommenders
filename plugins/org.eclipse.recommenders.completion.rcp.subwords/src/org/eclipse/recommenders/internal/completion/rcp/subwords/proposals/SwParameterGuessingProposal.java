...
public class SwParameterGuessingProposal extends JavaMethodCompletionProposal {

    protected SwParameterGuessingProposal(final CompletionProposal proposal,
            final JavaContentAssistInvocationContext context, final CompletionContext coreContext,
            final boolean fillBestGuess, final SubwordsProposalContext subwordsContext) {
