...
import static org.eclipse.recommenders.mining.calls.generation.callgroups.ReceiverCallGroupsContainer.newGroup;
...
public class TypeModelsBuilderTest {
    ...
    public void testBuildContextNode() {
        ...
        //
        // verify:
        final String[] expectedStates = ArrayUtils.toArray(ObjectUsage.DUMMY_METHOD.getIdentifier(),
                ctx1.getIdentifier(), ctx2.getIdentifier(), ctx3.getIdentifier(), ctx4.getIdentifier());
