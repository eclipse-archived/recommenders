...
/**
 * All Unit tests to be executed are included here. Furthermore this class provides access to several constructs, like
 * defined MethodCalls, that are used throughout the tests.
 */
