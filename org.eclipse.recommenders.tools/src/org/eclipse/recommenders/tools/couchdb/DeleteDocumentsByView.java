...
public class DeleteDocumentsByView {
    ...
    private static String couchdb = "http://localhost:5985/lfm/";
    private static String view = "_design/metaData/_view/libraryIdentifierMapping";
    ...
    public static void main(final String[] args) {
        ...
        for (final ResultObject<?> document : result.rows) {
            ...
            // client.doDeleteRequest(document.id + "?rev=" + revision,
