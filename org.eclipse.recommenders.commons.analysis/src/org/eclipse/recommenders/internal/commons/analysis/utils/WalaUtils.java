...
import static org.eclipse.recommenders.internal.commons.analysis.utils.ClassUtils.isPrimordial;
...
import org.eclipse.recommenders.commons.utils.IGenericFilter;
...
public class WalaUtils {
    ...
    public static Collection<File> getAllJarsInDirectory(final File directory, final boolean recursively) {
