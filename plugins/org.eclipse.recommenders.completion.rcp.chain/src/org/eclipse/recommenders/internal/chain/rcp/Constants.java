...
public class Constants {
    /**
     * This static class contains only the settings, which only affect the internal computation algorithm.
     */
    public static class AlgorithmSettings {
        /**
         * This setting sets the maximal computation time of the algorithm. The maximal plug-in computation time is
         * equal to {@link Constants.ProposalSettings#MAX_PROPOSAL_COMPUTATION_TIME_IN_MS} +
    ...
    /**
     * This static class contains only the settings, which only affect the proposal generation
     */
    public static class ProposalSettings {
        ...
        /**
         * This setting sets the maximal proposal computation time. The maximal plug-in computation time is equal to
        ...
        /**
         * This setting sets the image path for the image, which is displayed in the proposal box.
         */
        public static final String IMAGE_PATH = "/icons/view16/chain.gif";

        /**
         * This setting sets the plug-in ID, which is needed to display the image in the proposal box.
         * 
         * REVIEW: Is there another way to retrieve this id from the manifest.mf?
         */
        public static final String PLUGIN_ID = "org.eclipse.recommenders.completion.rcp.chain";
    }
