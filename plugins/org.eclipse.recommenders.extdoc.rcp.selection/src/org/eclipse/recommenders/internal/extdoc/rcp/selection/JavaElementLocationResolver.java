...
public final class JavaElementLocationResolver {
    ...
    protected static JavaElementLocation resolveLocation(final IJavaElement javaElement, final ASTNode astNode) {
        if (astNode == null && javaElement instanceof ITypeRoot) {
            return JavaElementLocation.TYPE_DECLARATION;
        } else if (astNode == null && javaElement instanceof IMethod) {
     ...
     * @param astNode
     *            AST node representing the selected Java element.
     * @return The type of the AST node indicating the Java element's location, e.g. "method declaration".
     */
     ...
     * @param javaElement
     *            The Java element to identify the location for.
     * @return The {@link JavaElementLocation} for the given Java element and its location node type.
     */
     ...
     * @return The {@link JavaElementLocation} - the "new" type, part of "extends" or part of "implements" - as
     *         identified from the Java element type.
     */
