...
import org.eclipse.recommenders.internal.server.codesearch.SearchResult;
import org.eclipse.recommenders.internal.server.codesearch.SearchService;
import org.eclipse.recommenders.internal.server.codesearch.TransactionResult;
import org.eclipse.recommenders.internal.server.codesearch.UriMapper;
...
public class CodeSearchResource {
    ...
    private void validate(final Feedback feedback) {
        ...
        // TODO add to CouchDB?
        // TODO need index for feedback?
        // TODO need document-type enum for feedback, example etc?
        // TODO need admin resource to allow me to fetch all feedbacks
