...
public class WorkspaceAndFixturesSetupSmokeTest {
    ...
    private static File fixturesBasedir = new File("../../fixtures/").getAbsoluteFile();
    private static String fixtureProjectName = "org.eclipse.recommenders.fixtures.empty-project";
