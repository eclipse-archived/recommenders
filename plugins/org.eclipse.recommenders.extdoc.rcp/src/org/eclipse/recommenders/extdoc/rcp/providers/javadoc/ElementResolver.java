...
public final class ElementResolver {
    ...
    public static IMethodName toRecMethod(final IMethod jdtMethod) {
        return getResolver().toRecMethod(jdtMethod);
    }

    public static IType toJdtType(final ITypeName jdtType) {
        return getResolver().toJdtType(jdtType);
    }

    // TODO discuss and understand annotation "@Provisional" and if this helper method is needed
    private static JavaElementResolver getResolver() {
        if(resolver == null) {
    ...
    public static ITypeName toRecType(final IType jdtType) {
        return new JavaElementResolver().toRecType(jdtType);
    }
