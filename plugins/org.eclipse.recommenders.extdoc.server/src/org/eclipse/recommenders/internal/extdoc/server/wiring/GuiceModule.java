...
import org.eclipse.recommenders.internal.extdoc.server.CouchDataAccess;
...
public final class GuiceModule extends AbstractModule {
    ...
    @Provides
    CouchDataAccess createDefaultDataAccess(@ExtDocScope final ClientConfiguration config) {
        return new CouchDataAccess(config);
    }
