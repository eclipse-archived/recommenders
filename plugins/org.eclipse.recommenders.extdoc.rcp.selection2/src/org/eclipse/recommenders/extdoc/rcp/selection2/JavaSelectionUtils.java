...
import static org.eclipse.recommenders.extdoc.rcp.selection2.JavaSelectionLocation.METHOD_DECLARATION_PARAMETER;
import static org.eclipse.recommenders.extdoc.rcp.selection2.JavaSelectionLocation.METHOD_DECLARATION_RETURN;
import static org.eclipse.recommenders.extdoc.rcp.selection2.JavaSelectionLocation.METHOD_DECLARATION_THROWS;
...
import static org.eclipse.recommenders.extdoc.rcp.selection2.JavaSelectionLocation.TYPE_DECLARATION_IMPLEMENTS;
import static org.eclipse.recommenders.extdoc.rcp.selection2.JavaSelectionLocation.UNKNOWN;
import static org.eclipse.recommenders.rcp.RecommendersPlugin.log;
...
/**
 * Utility class that resolves a selected java element from a text or structured selection.
 */
...
public class JavaSelectionUtils {
    ...
    public static JavaSelectionLocation resolveSelectionLocationFromEditor(final JavaEditor editor,
            final ITextSelection selection) {
        ensureIsNotNull(editor);
        ensureIsNotNull(selection);
