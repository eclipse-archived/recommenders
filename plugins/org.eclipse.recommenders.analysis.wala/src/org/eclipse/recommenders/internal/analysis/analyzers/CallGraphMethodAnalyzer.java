...
import org.eclipse.recommenders.internal.analysis.newsites.NewSiteReferenceForField;
import org.eclipse.recommenders.internal.analysis.newsites.NewSiteReferenceForMethodReturn;
            ...
            if (walaInstanceKey instanceof NormalAllocationInNode) {
                ...
                if (site instanceof NewSiteReferenceForField) {
                    ...
                    recInstanceKey.definitionSite = DefinitionSite
                            .newSite(
                                    org.eclipse.recommenders.internal.analysis.codeelements.DefinitionSite.Kind.METHOD_RETURN,
