...
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.CallsHitratioFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.CallsInverseHitratioFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.CallsInverseRatioFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.CallsRatioFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.CallsTFIDFFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.CallsWhatElseFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.FieldsHitratioFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.FieldsInverseRatioFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.FieldsRatioFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.FieldsTFIDFFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.InterfacesHitratioFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.InterfacesInverseRatioFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.InterfacesRatioFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.InterfacesTFIDFFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.OverridesHitratioFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.OverridesInverseRatioFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.OverridesRatioFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.OverridesTFIDFFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.SuperclassHitratioFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.SuperclassInverseRatioFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.SuperclassRatioFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.SuperclassTFIDFFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.UsesHitratioFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.UsesInverseHitratioFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.UsesInverseRatioFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.UsesRatioFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.UsesTFIDFFeatureScorer;
import org.eclipse.recommenders.server.codesearch.lucene.FeatureScorers.UsesWhatElseFeatureScorer;
