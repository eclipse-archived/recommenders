...
public final class LogMessages extends DefaultLogMessage {
    ...
    public static final LogMessages ERROR_FAILED_TO_COMPUTE_OVERRIDE_RECOMMENDATIONS = new LogMessages(ERROR,
            Messages.LOG_ERROR_FAILED_TO_COMPUTE_OVERRIDE_RECOMMENDATIONS);
