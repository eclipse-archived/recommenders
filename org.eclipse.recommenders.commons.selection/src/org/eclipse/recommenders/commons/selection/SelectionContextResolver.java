...
final class SelectionContextResolver {
    ...
    private ExtendedSelectionContext resolveFromEditor(final JavaEditor part, final ITextSelection selection)
        ...
        final ICompilationUnit compUnit = (ICompilationUnit) JavaUI.getEditorInputJavaElement(editorInput);
        final IJavaElement[] elements = compUnit.codeSelect(selection.getOffset(), 0);
